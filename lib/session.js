(function() {
  var Blog, Order, Product,Collect, Metafields, SCollection, Customer, Collection, Session, crypto, empty, isNumeric, sortObj, trim;
  ...
  Metafields = require('./resources/metafields');
  ...
  Session = (function() {
    ...
    function Session(url, apiKey, secret, params) {
      ...
      if (this.valid) {
        ...
        this.metafields = new Metafields(this.site());
