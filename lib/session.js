(function() {
  var PV, Blog, Order, Product,Collect, SCollection, Customer, Collection, Session, crypto, empty, isNumeric, sortObj, trim;
  ...
  //Metafields = require('./resources/metafield');
  SCollection = require('./resources/smart_collection');
  Collect = require('./resources/collect');
  Collection = require('./resources/custom_collection');
  PV = require('./resources/product_variant'); 
  ...
  Session = (function() {
    ...
    function Session(url, apiKey, secret, params) {
      ...
      if (this.valid) {
        ...
        this.pv = new PV(this.site());
      //  this.metafield = new Metafield(this.site());
        this.scollection = new SCollection(this.site());
        this.collection = new Collection(this.site());
