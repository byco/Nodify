(function() {
  var Blog, Customer, Collect, Metafield, SCollection, Collection, Order, Product, Resource, Session, SessionOAuth,
  ...
  SessionOAuth = (function(_super) {
    ...
    SessionOAuth.prototype.getScope = function(scope) {
      ...
      this.scope = scope;
      types = ['content', 'themes','metafield', 'products', 'customers', 'orders', 'script_tags', 'collect','scollections','collections','shipping'];
      scope = [];
