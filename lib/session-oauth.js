(function() {
  var Blog, Customer, SCollection, Collection, Order, Product, Resource, Session, SessionOAuth,
  ...
  SessionOAuth = (function(_super) {
    ...
    SessionOAuth.prototype.getScope = function(scope) {
      ...
      this.scope = scope;
      types = ['content', 'themes', 'products', 'customers', 'orders', 'script_tags', 'scollections','collections','shipping'];
      scope = [];
