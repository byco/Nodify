(function() {
  var Blog, Customer, Collect, Metafields, SCollection, Collection, Order, Product, Resource, Session, SessionOAuth,
  ...
  SessionOAuth = (function(_super) {
    ...
    SessionOAuth.prototype.getScope = function(scope) {
      ...
      this.scope = scope;
      types = ['content', 'themes','metafields', 'products', 'customers', 'orders', 'script_tags', 'collect','scollections','collections','shipping'];
      scope = [];
